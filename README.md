...
## Answer -> This week I learned that express can handle routing, middleware, and templates (for server-side routing)

- [x] Describe Middleware?

## Answer -> Middleware allows you to tap into the req and res objects, and adds extra funtionality to an app.

- [x] Describe a Resource?

## Answer -> A resource is a route or a response that the server uses to send information. In node everything is a resource.

- [x] What can the API return to help clients know if a request was successful?

## Answer -> Status codes are used to let the client know if a request was successful or unsuccessful (with other useful messages)

- [x] How can we partition our application into sub-applications?

## Asnwer -> Exporting and Importing files and using middleware can help brake down apps into smaller reusuable peices.
